  ...
  Widget build(context) {
    return Container(
      ...
      child: TextFormField(
        ...
        maxLength: widget.maxSize != null ?widget. maxSize : widget.isPhoneNumber ? 15 : null,
        ...
        decoration: InputDecoration(
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(0,0,Dimensions.PADDING_SIZE_SMALL,0),
          ...
          suffixIcon: widget.isPassword? GestureDetector(onTap: _toggle,
              child: Icon(_obscureText ? Icons.visibility_off : Icons.visibility)):SizedBox.shrink(),
